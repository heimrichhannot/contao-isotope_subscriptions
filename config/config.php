 ...
 * Backend modules
 */
HeimrichHannot\HastePlus\Arrays::insertInArrayByName($GLOBALS['BE_MOD']['isotope'], 'iso_rules', array(
	'iso_subscriptions' => array(
		...
		'export'			=> array('HeimrichHannot\IsotopeSubscriptions\IsotopeSubscriptions', 'export')
	))
);
