 ...
 * Palettes
 */
$arrDca['palettes']['iso_activation']   =
...
$arrFields = array(
    ...
    'iso_cancellationArchives' => array(
...
$arrFields['iso_addSubscriptionCheckbox'] = array(
...
{
    $arrDca['fields']['iso_direct_checkout_products']['fieldpalette']['fields'] = array_merge(
        $arrDca['fields']['iso_direct_checkout_products']['fieldpalette']['fields'],
        $arrFields
    );
    $arrDca['fields']['iso_direct_checkout_products']['fieldpalette']['config']['onload_callback'] = array('modifyPalette' => array('tl_module_isotope_subscriptions', 'modifyFieldPalette'));
    ...
    $arrDca['fields']['iso_direct_checkout_products']['fieldpalette']['subpalettes']['iso_addSubscription'] =
        'iso_subscriptionArchive,iso_addActivation';

    $arrDca['fields']['iso_direct_checkout_product_types']['fieldpalette']['fields'] = array_merge(
        $arrDca['fields']['iso_direct_checkout_product_types']['fieldpalette']['fields'],
        $arrFields
    );
    $arrDca['fields']['iso_direct_checkout_product_types']['fieldpalette']['config']['onload_callback'] = array('modifyPalette' => array('tl_module_isotope_subscriptions', 'modifyFieldPalette'));
