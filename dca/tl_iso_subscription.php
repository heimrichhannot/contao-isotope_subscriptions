...
class tl_iso_subscription extends \Backend
{
    ...
    public function editOrder(\DataContainer $objDc)
    {
        return ($objDc->value < 1) ? ''
            : ' <a href="contao/main.php?do=iso_orders&act=edit&id=' . $objDc->value . '&rt=' . \RequestToken::get() . '" title="' . sprintf(specialchars($GLOBALS['TL_LANG']['tl_content']['editalias'][1]), $objDc->value) . '" style="padding-left:3px">'
              . \Image::getHtml('alias.gif', $GLOBALS['TL_LANG']['tl_content']['editalias'][0], 'style="vertical-align:top"') . '</a>';
    }
